...
case-studies/mcp-factory.html      case study 1 — manifest-driven MCP scaffolder (348 tests, public + Loom)
case-studies/rag-mcp.html          case study 2 — RAG retrieval MCP (155 tests, local/$0)
...
- **mcp-factory — 348 passing tests**, public repo + 90-second Loom demo.
- **rag-mcp — 155 tests**, local ONNX (bge-large) embeddings, $0 inference cost.
