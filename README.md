...
case-studies/mcp-factory.html      case study 1 — manifest-driven MCP scaffolder (179 tests, public + Loom)
...
- **mcp-factory — 179 passing tests**, public repo + 90-second Loom demo.
- **rag-mcp — 50 tests**, local ONNX (bge-large) embeddings, $0 inference cost.
