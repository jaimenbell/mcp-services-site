...
<footer class="site">
  <div class="wrap">
    ...
    <span><a href="https://github.com/jaimenbell/MCP-Factory">GitHub</a> · <a href="mailto:jaime@jaimenbell.dev">jaime@jaimenbell.dev</a> <span id="discord-footer-link-wrap">· <a id="discord-footer-link" href="https://discord.gg/Xw3QNsUdYh" target="_blank" rel="noopener">Discord</a></span></span>
  </div>
</footer>
