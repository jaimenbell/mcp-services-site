...
- Test counts (222 mcp-factory, 60 rag-mcp, 371 options-bot, 264 mcp-security-scanner) were
  ...
  195 -> 257 -> 264 passing / 271 total (tool-discovery low-level SDK + detector-5/6 low-level coverage,
